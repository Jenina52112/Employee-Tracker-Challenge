...
INSERT INTO employees (Employee_Id, First_Name, Last_Name, Job_title, Department, Salary, Manager_name)
VALUES (701, 'Jasmin', 'Gonzalez', 'Packer', 'Packing', 'JGALVAN'),
        (702, 'Medel', 'Cruz', 'Am Supervisor', 'Picking', 'Juan'),
